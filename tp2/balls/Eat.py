...
implements the Eat class
Lukas Peraza, 2016 for 15-112 Pygame Lecture format copied
'''
import pygame
...
class Eat(pygame.sprite.Sprite):
    ...
    def updateImage(self):
        self.image = Eat.frames[self.frame]
